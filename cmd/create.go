...
var createCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(params.Links) != 0 {
			jira.LinkingTicket(params, ticket_id)
		}
	},
}
...
func init() {
	...
	createCmd.Flags().StringVarP(&params.Priority, "priority", "y", "Medium", "Specifies ticket priority e.g. Medium, High, Low, Highest, Lowerst")
	createCmd.Flags().StringVarP(&params.Project, "project", "p", "", "Specifies project name you want to put a ticket on")
	...
	createCmd.Flags().StringSliceVarP(&params.Components, "component", "c", []string{}, "Specifies ticket component. it can be put multiple component with comma, like 'component1,component2'")
	createCmd.Flags().StringVarP(&params.Epic, "epic", "e", "", "Specifies EpicID")
	createCmd.Flags().StringVarP(&params.Assignee, "assign", "a", "", "Specifies ticket assignee")
	createCmd.Flags().StringVarP(&params.Reporter, "reporter", "r", "", "Specifies ticket reporter")
